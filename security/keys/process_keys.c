...
{
//printk("security/keys/process_keys.c:init_root_keyring START\n");
	int ret = look_up_user_keyrings(NULL, NULL);
//printk("security/keys/process_keys.c:init_root_keyring END\n");
	return ret;
}
