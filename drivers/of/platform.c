...
//printk("drivers/of/platform.c:of_platform_device_create_pdata CALLS of_device_add\n");
...
//printk("drivers/of/platform.c:of_platform_bus_create CALLS of_platform_device_create_pdata\n");
...
//printk("drivers/of/platform.c:of_platform_populate CALLS of_platform_bus_create\n");
...
int of_platform_default_populate(struct device_node *root,
				 ...
				 struct device *parent)
{
//printk("drivers/of/platform.c:of_platform_default_populate CALLS of_platform_populate\n");
...
static int __init of_platform_default_populate_init(void)
{
	...
	if (node) {
//printk("drivers/of/platform.c:of_platform_default_populate_init CALLS of_platform_populate\n");
...
{
//printk("drivers/of/platform.c:of_platform_sync_state_init START\n");
	device_links_supplier_sync_state_resume();
//printk("drivers/of/platform.c:of_platform_sync_state_init END\n");
	return 0;
}
...
int devm_of_platform_populate(struct device *dev)
{
	...
	if (!ptr)
		return -ENOMEM;
//printk("drivers/of/platform.c:devm_of_platform_populate CALLS of_platform_populate START\n");
