...
{
//printk("drivers/base/power/domain.c:genpd_power_off_unused START\n");
	struct generic_pm_domain *genpd;
...
//printk("drivers/base/power/domain.c:genpd_power_off_unused END\n");
	return 0;
}
...
{
//printk("drivers/base/power/domain.c:genpd_debug_init START\n");
	struct generic_pm_domain *genpd;
	...
	list_for_each_entry(genpd, &gpd_list, gpd_list_node)
		genpd_debug_add(genpd);
//printk("drivers/base/power/domain.c:genpd_debug_init END\n");
	return 0;
}
