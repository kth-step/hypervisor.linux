...
{
	struct clk_core *core;
//printk("drivers/clk.c:clk_disable_unused START\n");
	if (clk_ignore_unused) {
		pr_warn("clk: Not disabling unused clocks\n");
//printk("drivers/clk.c:clk_disable_unused END\n");
		return 0;
	}
...
{
	struct clk_core *core;
//printk("drivers/clk/clk.c:clk_debug_init START\n");
	...
	inited = 1;
	mutex_unlock(&clk_debug_lock);
//printk("drivers/clk/clk.c:clk_debug_init END\n");
	return 0;
}
