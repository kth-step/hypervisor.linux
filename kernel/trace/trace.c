...
{
//printk("kernel/trace/trace.c:latency_fsnotify_init START\n");
	fsnotify_wq = alloc_workqueue("tr_max_lat_wq",
				      WQ_UNBOUND | WQ_HIGHPRI, 0);
	if (!fsnotify_wq) {
		pr_err("Unable to allocate tr_max_lat_wq\n");
//printk("kernel/trace/trace.c:latency_fsnotify_init END\n");
		return -ENOMEM;
	}
//printk("kernel/trace/trace.c:latency_fsnotify_init END\n");
	return 0;
...
{
//printk("kernel/trace/trace.c:trace_eval_sync START\n");
	/* Make sure the eval map updates are finished */
	if (eval_map_wq)
		destroy_workqueue(eval_map_wq);
//printk("kernel/trace/trace.c:trace_eval_sync END\n");
	return 0;
}
...
{
//printk("kernel/trace/trace.c:late_trace_init START\n");
	...
	clear_boot_tracer();
//printk("kernel/trace/trace.c:late_trace_init END\n");
	return 0;
}
