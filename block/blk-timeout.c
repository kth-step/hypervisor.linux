...
{
printk("block/blk-timeout.c:fail_io_timeout_debugfs START\n");
	struct dentry *dir = fault_create_debugfs_attr("fail_io_timeout",
						NULL, &fail_io_timeout);
	int ret = PTR_ERR_OR_ZERO(dir);
printk("block/blk-timeout.c:fail_io_timeout_debugfs END\n");
	return ret;
}
...
{
//printk("block/blk-timeout.c:blk_timeout_init START\n");
	blk_timeout_mask = roundup_pow_of_two(HZ) - 1;
//printk("block/blk-timeout.c:blk_timeout_init END\n");
	return 0;
}
