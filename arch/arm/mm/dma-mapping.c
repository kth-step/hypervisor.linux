...
#ifdef CONFIG_TRUSTFULL_HYPERVISOR
	//pte is virtual address to l2 entry, which is mk_pte(page, prot), where page is a physical address.
	//Checks that the l2 entry is unchanged.
//	asm volatile ("mov R0, %0	\n\t"
//				  "mov R1, %1	\n\t"
//				  "SWI 1062"
//				  :: "r" (addr), "r" (mk_pte(page, prot)) : "memory", "r0", "r1");
#else
