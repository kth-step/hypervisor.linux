...
#ifdef CONFIG_TRUSTFULL_HYPERVISOR /* Size of VMALLOC Reserve space for DMMU table 256MB */
//VMALLOC_END =
//0xC000_0000 + 0x3000_0000 - 0x0800_0000 =
//0xF000_0000 - 0x0800_0000 = 0xE800_0000 =
//2^31 + 2^30 + 20^29 + 2^27 = 2GB + 1 GB + ½GB + 1/8GB = 3.625GB
//0xC000_0000 = 2^31 + 2^30 = 2GB + 1GB = 3GB
//MUST BE EQUAL TO arch/arm/include/asm/memory.h:FDT_FIXED_BASE.
//Subtracted by 5 instead of 2 for arch/arm/include/asm/fixmap.h:FIXADDR_START and FIXADDR_END.
#define VMALLOC_END		UL(0xE8000000 - 0x00500000)
#else
