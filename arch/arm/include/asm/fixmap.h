...
#define FIXADDR_START	UL(0xE8000000 - 0x00500000 + 0x00200000)	//Start 3MB below dmmu tables. Must start after 2MB device tree.
#define FIXADDR_END		UL(0xE8000000 - 0x00500000 + 0x00200000 + 0xfff00000 - 0xffc80000)		//End 0.5MB below dmmu tables.
#else
