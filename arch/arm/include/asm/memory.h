...
//Hypervisor uses the 128MB virtual addresses [0xE800_0000, 0xF000_0000) to
//access Linux memory. The DTB needs 2MB. This requires VMALLOC_END to be set
//to the same value: 0xE8000000 - 0x00200000.
//Must be equal to arch/arm/include/asm/pgtable.h:VMALLOC_END.
//Subtracted by 5 instead of 2 for arch/arm/include/asm/fixmap.h:FIXADDR_START and FIXADDR_END.
#define FDT_FIXED_BASE		UL(0xE8000000 - 0x00500000)
#else
